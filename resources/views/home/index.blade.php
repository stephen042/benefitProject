            ...
            <div class="single-item">
              ...
              <div class="text-box">
                ...
                <h3 class="single-item-description">
                  Earn daily returns on your investments, maximizing your financial growth every single day.
                </h3>
              </div>
            </div>
          </div> --}}
          <div class="col">
            <div class="single-item">
              ...
              <div class="text-box">
                ...
                <h3 class="single-item-description">
                  Experience the fastest and most reliable payment processing in the industry.
                </h3>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="single-item">
              ...
              <div class="text-box">
                ...
                <h3 class="single-item-description">
                  Our platform is designed for simplicity—start investing in just a few clicks.
                </h3>
              </div>
            </div>
          </div>
          <div class="col">
            <div class="single-item">
              ...
              <div class="text-box">
                ...
                <h3 class="single-item-description">
                  Your funds and data are protected with advanced security protocols.
                </h3>
              </div>
            </div>
          </div>
